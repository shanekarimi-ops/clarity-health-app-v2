  ...
  return (
    <div className="dash-layout">
      ...
      <main className="dash-main">
        <ComingSoonCard
          title="Presentations"
          tagline="Branded client deliverables in PDF and Excel, generated in seconds."
          phase="Phase 6 (S37)"
          features={[
            'Branded PDFs that pull from your agency branding settings',
            'Multiple templates: standard, executive summary, detailed',
            'Excel exports with editable cost modeling',
            'Track delivery status: draft, finalized, sent to client',
          ]}
        />
      </main>
    </div>
