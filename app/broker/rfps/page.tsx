  ...
  return (
    <div className="dash-layout">
      ...
      <main className="dash-main">
        <ComingSoonCard
          title="RFPs"
          tagline="Build, distribute, and track marketing events for your clients."
          phase="Phase 3 (S31–S32)"
          features={[
            'Multi-step RFP wizard with SPD-driven auto-population',
            'AI extraction of plan designs from current and renewal documents',
            'Distribute one RFP to multiple carriers across multiple benefits',
            'Real-time tracking of carrier engagement and proposal status',
          ]}
        />
      </main>
    </div>
