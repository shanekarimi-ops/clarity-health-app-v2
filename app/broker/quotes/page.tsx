  ...
  return (
    <div className="dash-layout">
      ...
      <main className="dash-main">
        <ComingSoonCard
          title="Quotes"
          tagline="Receive, parse, and compare carrier proposals side-by-side."
          phase="Phase 5 (S35–S36)"
          features={[
            'AI-powered extraction of plan designs from carrier proposals',
            'Side-by-side comparison view across multiple carriers',
            'Variance highlighting versus the current plan',
            'Filter, sort, and shortlist with instant cost modeling',
          ]}
        />
      </main>
    </div>
